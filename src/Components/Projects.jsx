    ...
    <div id="Proyectos" className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
      <div className="grid md:grid-cols-2 gap-8">
        <div className="bg-white/25 backdrop-blur-lg border border-white/18 rounded-lg p-8 shadow-lg">
          ...
          <a
            href="#"
            className="bg-green-100 text-purple-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded-md dark:bg-gray-700 dark:text-purple-400 mb-2 mx-2"
          >
            <svg
              className="w-2.5 h-2.5 me-1.5"
              aria-hidden="true"
          ...
          <p className="text-lg font-normal text-gray-500 dark:text-gray-400 mb-4">
            ...
            evolución de los datos, y generación de informes.
          </p>
